...
const Footer = () => {
    const footerLinks = {
        ...
        explore: [
            { name: 'PUMA App', href: '/app' },
            { name: 'PUMA Stores', href: '/stores' },
    ...
    const socialLinks = [
        { name: 'Facebook', icon: Facebook, href: 'https://facebook.com/puma' },
        { name: 'Instagram', icon: Instagram, href: 'https://instagram.com/puma' },
        { name: 'Twitter', icon: Twitter, href: 'https://twitter.com/puma' },
        { name: 'Youtube', icon: Youtube, href: 'https://youtube.com/puma' },
    ];
        ...
        <footer className="bg-black text-white mt-auto no-print">
                ...
                <div className="container-custom py-12 md:py-16">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-neutral-400 mb-8 text-sm md:text-base max-w-2xl mx-auto">
                            Sign up for email updates on the latest PUMA products, stories and events
                        </p>
            ...
            <div className="container-custom py-12 md:py-16">
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
                    {/* Support */}
                    <div>
                        <h4 className="font-black text-sm uppercase tracking-wider mb-6">SUPPORT</h4>
                    ...
                    {/* About */}
                    <div>
                        <h4 className="font-black text-sm uppercase tracking-wider mb-6">ABOUT</h4>
                        <ul className="space-y-3">
                    ...
                    {/* Explore */}
                    <div>
                        <h4 className="font-black text-sm uppercase tracking-wider mb-6">EXPLORE</h4>
                        <ul className="space-y-3">
                    ...
                    {/* More */}
                    <div>
                        <h4 className="font-black text-sm uppercase tracking-wider mb-6">MORE</h4>
                        <ul className="space-y-3">
                    ...
                    <div className="col-span-2 md:col-span-4 lg:col-span-1">
                        <h4 className="font-black text-sm uppercase tracking-wider mb-6">CONTACT</h4>
                        <ul className="space-y-4 text-sm text-neutral-400">
                            ...
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:support@puma.com" className="hover:text-white transition-colors">
                                        support@puma.com
                                    </a>
                                </div>
                            </li>
                ...
                <div className="pt-8 border-t border-neutral-800">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-8">
                        ...
                        {/* Payment Methods */}
                        <div>
                            <p className="text-xs uppercase tracking-wider text-neutral-500 mb-4 text-center md:text-right">
                                WE ACCEPT
                            </p>
                            <div className="flex items-center gap-3">
                                {paymentMethods.map((method) => (
                                    <div
                                        key={method.name}
                                        className="w-12 h-8 bg-neutral-800 rounded flex items-center justify-center text-lg"
                                        title={method.name}
                                    >
                                        {method.logo}
                                    </div>
                    ...
                    <div className="pt-8 border-t border-neutral-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-neutral-500">
                        ...
                        <div className="text-center md:text-right">
                            <p>&copy; {new Date().getFullYear()} PUMA SE. All Rights Reserved.</p>
                            <p className="mt-1">PUMA India | Forever Faster</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-neutral-950 py-4">
                <div className="container-custom">
                    <div className="flex flex-col md:flex-row justify-center items-center gap-4 text-xs text-neutral-600">
                        <span>Web ID: IN-PUMA-2024</span>
